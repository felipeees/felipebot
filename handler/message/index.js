    ...
    try {
        ...
        case 'help':
            await client.sendText(from, menuId.textMenu(pushname))
                .then(() => ((isGroupMsg) && (isGroupAdmins)) ? client.sendText(from, 'Menu Admin Grupo: *#menuadmin*') : null)
            break
        case 'menuadmin':
        ...
        case 'stiker': {
            if ((isMedia || isQuotedImage) && args.length === 0) {
                ...
                */
                ...
                await client.reply(from, 'Sem imagem! Para abrir uma lista de comandos de envio #menu [Formato errado]', id)
            }
            break
        }
        case 'stikergif':
        ...
        case 'instagram':
            ...
            downloader.insta(url).then(async (data) => {
                ...
                .catch((err) => {
                    ...
                    client.reply(from, 'Erro, usuário privado [Link privado ou inválido]', id)
                })
            break
        case 'twt':
        case 'twitter':
        ...
        case 'facebook':
            ...
            await client.reply(from, 'OBRIGADO POR USAR O BOT', id)
        ...
        case 'meme':
            if ((isMedia || isQuotedImage) && args.length >= 2) {
                ...
                await client.reply(from, 'Sem imagem! Para abrir como usar o digite #menu [Formato errado]', id)
            }
            break
        case 'resi':
        ...
        case 'daradmin':
            ...
            if (mentionedJidList[0] === botNumber) return await client.reply(from, 'Desculpe, o formato da mensagem está errado, por favor verifique o menu. [Formato incorreto]', id)
            await client.daradminParticipant(groupId, mentionedJidList[0])
        ...
        case 'tiraradmin':
            ...
            if (mentionedJidList[0] === botNumber) return await client.reply(from, 'Desculpe, o formato da mensagem está errado, por favor verifique o menu. [Formato incorreto]', id)
            await client.tiraradminParticipant(groupId, mentionedJidList[0])
